...
// Code from different codebase
#pragma warning disable IDE1006 // Naming Styles
// Non-Trivial logic update with no reason due to obsolete snippets
#pragma warning disable CS0618 // Type or member is obsolete

namespace OpenGL.GUI;

/// <summary>
///     ImGui backend, uses the ImGuiNET library and handles buffer synchro and vertex generation
/// </summary>
public class ImGuiController : IDisposable
{
    ...
    public void CreateDeviceResources()
    {
        ...
        const string vertPath = "Shaders/UI.vert";
        string vertexSource = File.ReadAllText(vertPath);

        const string fragPath = "Shaders/UI.frag";
